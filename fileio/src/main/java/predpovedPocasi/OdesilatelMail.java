...
String adr = "homer.bond@seznam.cz";
        ...
        try (BufferedReader file = new BufferedReader(new FileReader("C:/Users/David/git/project2/fileio/201504111027.png"))) {
                   //adr += file.readLine();
        }
        catch (Exception e) {
        ...
        try {
            ...
            message.setText("vsichni jsou uz mrtvi Dejve dne 22.4");

            //MimeBodyPart messageBodyPart = new MimeBodyPart();
            //DataSource fds = new FileDataSource("fileio/201504111027.png");
